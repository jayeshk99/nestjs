...
export const RESOURCE_TYPE = {
  ...
  FSX: 'FSx',
  RDS: 'RDS',
  AWS_LOAD: 'AWS Load Balancers',
  AWS_RG: 'AWS Resource Groups',
  ECR: 'ECR',
  EKS: 'EKS',
...
export const LIST_RESOURCE_KEY = {
  ...
  EFS: 'FileSystems',
  FSx: 'FileSystems',
  S3_GLACIER: 'VaultList',
  RDS: 'DBInstances',
  ECR: 'repositories',
  EKS: 'clusters',
  AWS_LOAD: 'LoadBalancerDescriptions',
  AWS_LOAD_V2: 'LoadBalancers',
